...
import com.rl.kanmeitu02.data.imgloader.helper.DiskCacheHelper;
import com.rl.kanmeitu02.data.imgloader.helper.MemoryCacheHelper;
import com.rl.kanmeitu02.data.imgloader.helper.NetworkHelper;
import com.rl.kanmeitu02.utils.SizeUtils;
    ...
    private Handler mMainHandler = new Handler(Looper.getMainLooper()){
        ...
        public void handleMessage(Message msg) {
            ...
            if (uri.equals(result.uri)) {
                ...
                Log.w(TAG, "URL发生改变，不设置图片");    //  线程延迟，最后设置的Tag才有效
//                resultImage.setImageBitmap(result.bitmap);
            }
        }
    };
        ...
        Runnable loadBitmapTask = new Runnable() {
            ...
            public void run() {
                ...
                if(bitmap != null) {
                    ...
                    Log.w(TAG,"图片未缓存，请先缓存图片");  // bug: 无输出
                }
            }
        };
