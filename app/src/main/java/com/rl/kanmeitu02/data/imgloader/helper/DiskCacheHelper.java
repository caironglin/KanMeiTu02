package com.rl.kanmeitu02.data.imgloader.helper;
...
import com.rl.kanmeitu02.data.imgloader.SisterCompress;
import com.rl.kanmeitu02.data.imgloader.disklrucache.DiskLruCache;
    ...
    public Bitmap saveImgByte(String key, int reqWidth, int reqHeight,byte[] bytes) {
        ...
        try {
            ...
            if (editor != null) {
                ...
                output.write(bytes);    // bug java.lang.NullPointerException
                output.flush();
                editor.commit();
                output.close();
